...
@Component({
  ...
  imports: [ComicsDatabaseGridComponent, CommonModule, SeriesGridComponent, NoResultsComponent, LoadingSpinnerPageComponent, ComicDatabaseTableComponent, SeriesTableComponent],
...
export class LibraryPageComponent implements OnInit {
  ...
  constructor() {
    this.filteredSeries$ = combineLatest([
      ...
      map(([series, filter, search]) => this.filterSeries(series, filter, search)),
    );
    ...
    this.filteredComics$ = combineLatest([
      ...
      map(([comics, filter, search, _]) => this.filterComics(comics, filter, search)),
    );
  }
  ...
  filterComics(comics: ComicsDatabase[], filter: FilterFunnel | null, search: string): ComicsDatabase[] {
