...
export class SettingsPageComponent {
  ...
  private getconfig() {
    this.darkModeService.isDarkMode$.pipe(untilDestroyed(this)).subscribe((isDarkMode) => {
  ...
  sendEnableNotifications() {
    this.configService
      .setEnableSlackNotifications(this.slackConfiguration.enableNotifications)
      .pipe(untilDestroyed(this))
      .subscribe();
  }
  ...
  sendDeleteArchives() {
    this.configService
      .setDeleteArchives(this.deleteArchives)
      .pipe(untilDestroyed(this))
      .subscribe();
  }
  ...
  sendGenerateNavigationThumbnails() {
    this.configService
      .setGenerateNavigationThumbnails(this.generateNavigationThumbnails)
      .pipe(untilDestroyed(this))
      .subscribe();
  }
    ...
    this.serverInfoService
      ...
      .pipe(
        switchMap((serverInfo) =>
          this.modalService.open<null, { serverInfo: ServerInfo | undefined }>(
            ModalServerInfoComponent,
