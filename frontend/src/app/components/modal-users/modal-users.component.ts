...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, FormsModule, InputTextComponent, CrossModalComponent, InputColorComponent],
  templateUrl: './modal-users.component.html'
})
export class ModalUsersComponent implements ModalComponent<RegisterRequest, { input: ModalUsersComponentInput | undefined }>, OnInit, OnChanges {
