...
@Component({
    ...
    imports: [ComicsSearchGridComponent, CommonModule, NoResultsComponent, LoadingSpinnerPageComponent, MiniSpinnerComponent, ErrorPageComponent, ComicSearchTableComponent],
...
export class SearchPageComponent implements OnInit {
    ...
    constructor() {
        ...
        this.activePageService.isDetailsPage$.pipe(
            delay(1000),
            untilDestroyed(this)
    ...
    ngOnInit(): void {
        this.windowService.scrollBottom$.pipe(
